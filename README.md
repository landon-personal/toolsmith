...
The project is intentionally small in v0.1.0. It provides a TypeScript Node CLI with a local mock evaluation pipeline:
...
ToolSmith does not call models, send email, edit calendars, connect to databases, use API keys, or print environment variables.
...
v0.1.0 stops at a local mock evaluator. Real model/API integration is intentionally out of scope.
